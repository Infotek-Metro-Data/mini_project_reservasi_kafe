...
@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-white drop-shadow-lg">Tambah Ruangan</h1>
</div>
        ...
        <div class="mb-4">
            ...
            <div class="grid grid-cols-3 gap-3">
                <label class="relative cursor-pointer">
                    <input type="radio" name="tipe" value="interior" class="peer sr-only" {{ old('tipe') == 'interior' ? 'checked' : '' }} required>
                ...
                <label class="relative cursor-pointer">
                    <input type="radio" name="tipe" value="rooftop" class="peer sr-only" {{ old('tipe') == 'rooftop' ? 'checked' : '' }} required>
                    <div class="p-4 border-2 border-gray-300 rounded-xl text-center transition-all duration-200
                        peer-checked:border-amber-600 peer-checked:bg-amber-50 peer-checked:shadow-lg
                        hover:border-amber-400 hover:shadow-md">
                        <div class="flex flex-col items-center space-y-2">
                ...
                <label class="relative cursor-pointer">
                    <input type="radio" name="tipe" value="meeting_room" class="peer sr-only" {{ old('tipe') == 'meeting_room' ? 'checked' : '' }} required>
                    <div class="p-4 border-2 border-gray-300 rounded-xl text-center transition-all duration-200
                        peer-checked:border-amber-600 peer-checked:bg-amber-50 peer-checked:shadow-lg
                        hover:border-amber-400 hover:shadow-md">
                        <div class="flex flex-col items-center space-y-2">
